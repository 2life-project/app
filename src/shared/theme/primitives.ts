...
export const size = {
   ...
   *
   * Величина снята с экрана: плавающая панель iOS 26 поднимается на 77pt от
   * нижнего края, и в этот же отступ уложена безопасная зона — складывать их
   * нельзя, у панели она уже внутри.
   */
  tabBar: 96,
} as const;
