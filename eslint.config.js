...
module.exports = defineConfig([
  ...
  prettierRecommended,
  {
    ignores: [
      ...
      // Рабочие копии других веток. Алиас `@/*` у них резолвится в этот же
      // `src`, поэтому файл, удалённый здесь, ломает проверку там — хотя к
      // текущей ветке отношения не имеет.
      '.claude/worktrees/**',
    ],
  },
  {
